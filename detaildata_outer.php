...
include "koneksi.php";
$query = mysqli_query($koneksi, "SELECT * FROM tb_outer WHERE id='$id'");
...
<body>
    ...
    <div class="container-sm mb-5" style="background-color:white; max-width:80%; height:auto;">
        <h3 class="text-center p-3">DETAIL DATA OUTER MARKER SELEX 2130</h3>
        ...
        <center>
            <a href="data_outer.php" class="btn btn-secondary m-3">KEMBALI</a>
