...
<body>
    ...
    <div class="container-sm mb-5" style="background-color:white; max-width:80%; height:auto;">
        <form action="simpandata_localizer.php" method="POST">
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    <h3 class="text-center p-3">TAMBAH DATA LOCALIZER</h3>
                    <div class="row">
                    ...
                    <table class="table table-striped table-bordered text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>CENTERLINE SDM</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data127">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data128">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data129">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data130">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data131">
                                </td>
                            </tr>
                            <tr>
                                <td>IDENT MOD PERCENT</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data132">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data133">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data134">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data135">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data136">
                                </td>
                            </tr>
                            <tr>
                                <td>WIDTH DDM</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data137">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data138">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data139">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data140">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data141">
                                </td>
                            </tr>
                            <tr>
                                <td>IDENT STATUS</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data142">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data143">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data144">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data145">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data146">
                                </td>
                            </tr>
                            <tr>
                                <td>SYNTH LOCK/REV SENSE</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data147">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data148">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data149">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data150">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data151">
                                </td>
                            </tr>
                            <tr>
                                <th rowspan="2">CLEARENCE</th>
                            ...
                            <tr>
                                <td>CENTERLINE RF LEVEL</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data152">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data153">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data154">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data155">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data156">
                                </td>
                            </tr>
                            <tr>
                                <td>CENTERLINE DDM</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data157">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data158">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data159">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data160">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data161">
                                </td>
                            </tr>
                            <tr>
                                <td>CENTERLINE SDM</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data162">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data163">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data164">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data165">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data166">
                                </td>
                            </tr>
                            <tr>
                                <td>IDENT MOD PERCENT</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data167">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data168">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data169">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data170">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data171">
                                </td>
                            </tr>
                            <tr>
                                <td>WIDTH DDM</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data172">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data173">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data174">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data175">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data176">
                                </td>
                            </tr>
                            <tr>
                                <td>IDENT STATUS</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data177">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data178">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data179">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data180">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data181">
                                </td>
                            </tr>
                            <tr>
                                <td>SYNTH LOCK/REV SENSE</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data182">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data183">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data184">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data185">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data186">
                                </td>
                            </tr>
                            <tr>
                                <td>RF FREQ DIFFERENCE</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data187">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data188">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data189">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data190">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data191">
                                </td>
                            </tr>
                            <tr>
                                <td>ANTENNA FAULT</td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data192">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data193">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data194">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data195">
                                </td>
                                <td>
                                    <input type="text" class="inputtable" autocomplete="off" name="data196">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <center>
                <a href="data_localizer.php" class="btn btn-secondary m-3">KEMBALI</a>
