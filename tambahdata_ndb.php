...
<body>
    ...
    <div class="container-sm mb-5" style="background-color:white; max-width:80%; height:auto;">
        <form action="simpandata_ndb.php" method="POST">
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    <h3 class="text-center p-3">TAMBAH DATA NDB</h3>
                    <div class="row">
                    ...
                    <table class="table table-striped table-bordered text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="10">
                                    <textarea cols="30" rows="20" name="data21"></textarea>
                                </td>
                            </tr>
                            <tr>
