...
$simpan = mysqli_query($koneksi, "INSERT INTO tb_outer VALUES ('$id','$tanggal','$shift','$personel1','$personel2','$personel3','$personel4','$personel5','$personel6','$data1','$data2','$data3','$data4','$data5','$data6','$data7','$data8','$data9','$data10',
...
if($simpan){
    ...
    header("refresh:0;data_outer.php");
}else{
