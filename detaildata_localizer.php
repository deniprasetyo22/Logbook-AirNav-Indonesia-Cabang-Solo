...
include "koneksi.php";
$query = mysqli_query($koneksi, "SELECT * FROM tb_localizer WHERE id='$id'");
...
<body>
    ...
    <div class="container-sm mb-5" style="background-color:white; max-width:80%; height:auto;">
        <h3 class="text-center p-3">DETAIL DATA LOCALIZER SELEX 2100</h3>
            ...
            <table class="table table-striped table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>CENTERLINE SDM</td>
                        <td>
                            <?php echo $result['data127'] ?>
                        </td>
                        <td>
                            <?php echo $result['data128'] ?>
                        </td>
                        <td>
                            <?php echo $result['data129'] ?>
                        </td>
                        <td>
                            <?php echo $result['data130'] ?>
                        </td>
                        <td>
                            <?php echo $result['data131'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>IDENT MOD PERCENT</td>
                        <td>
                            <?php echo $result['data132'] ?>
                        </td>
                        <td>
                            <?php echo $result['data133'] ?>
                        </td>
                        <td>
                            <?php echo $result['data134'] ?>
                        </td>
                        <td>
                            <?php echo $result['data135'] ?>
                        </td>
                        <td>
                            <?php echo $result['data136'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>WIDTH DDM</td>
                        <td>
                            <?php echo $result['data137'] ?>
                        </td>
                        <td>
                            <?php echo $result['data138'] ?>
                        </td>
                        <td>
                            <?php echo $result['data139'] ?>
                        </td>
                        <td>
                            <?php echo $result['data140'] ?>
                        </td>
                        <td>
                            <?php echo $result['data141'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>IDENT STATUS</td>
                        <td>
                            <?php echo $result['data142'] ?>
                        </td>
                        <td>
                            <?php echo $result['data143'] ?>
                        </td>
                        <td>
                            <?php echo $result['data144'] ?>
                        </td>
                        <td>
                            <?php echo $result['data145'] ?>
                        </td>
                        <td>
                            <?php echo $result['data146'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>SYNTH LOCK/REV SENSE</td>
                        <td>
                            <?php echo $result['data147'] ?>
                        </td>
                        <td>
                            <?php echo $result['data148'] ?>
                        </td>
                        <td>
                            <?php echo $result['data149'] ?>
                        </td>
                        <td>
                            <?php echo $result['data150'] ?>
                        </td>
                        <td>
                            <?php echo $result['data151'] ?>
                        </td>
                    </tr>
                    <tr>
                        <th rowspan="2">CLEARENCE</th>
                    ...
                    <tr>
                        <td>CENTERLINE RF LEVEL</td>
                        <td>
                            <?php echo $result['data152'] ?>
                        </td>
                        <td>
                            <?php echo $result['data153'] ?>
                        </td>
                        <td>
                            <?php echo $result['data154'] ?>
                        </td>
                        <td>
                            <?php echo $result['data155'] ?>
                        </td>
                        <td>
                            <?php echo $result['data156'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>CENTERLINE DDM</td>
                        <td>
                            <?php echo $result['data157'] ?>
                        </td>
                        <td>
                            <?php echo $result['data158'] ?>
                        </td>
                        <td>
                            <?php echo $result['data159'] ?>
                        </td>
                        <td>
                            <?php echo $result['data160'] ?>
                        </td>
                        <td>
                            <?php echo $result['data161'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>CENTERLINE SDM</td>
                        <td>
                            <?php echo $result['data162'] ?>
                        </td>
                        <td>
                            <?php echo $result['data163'] ?>
                        </td>
                        <td>
                            <?php echo $result['data164'] ?>
                        </td>
                        <td>
                            <?php echo $result['data165'] ?>
                        </td>
                        <td>
                            <?php echo $result['data166'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>IDENT MOD PERCENT</td>
                        <td>
                            <?php echo $result['data167'] ?>
                        </td>
                        <td>
                            <?php echo $result['data168'] ?>
                        </td>
                        <td>
                            <?php echo $result['data169'] ?>
                        </td>
                        <td>
                            <?php echo $result['data170'] ?>
                        </td>
                        <td>
                            <?php echo $result['data171'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>WIDTH DDM</td>
                        <td>
                            <?php echo $result['data172'] ?>
                        </td>
                        <td>
                            <?php echo $result['data173'] ?>
                        </td>
                        <td>
                            <?php echo $result['data174'] ?>
                        </td>
                        <td>
                            <?php echo $result['data175'] ?>
                        </td>
                        <td>
                            <?php echo $result['data176'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>IDENT STATUS</td>
                        <td>
                            <?php echo $result['data177'] ?>
                        </td>
                        <td>
                            <?php echo $result['data178'] ?>
                        </td>
                        <td>
                            <?php echo $result['data179'] ?>
                        </td>
                        <td>
                            <?php echo $result['data180'] ?>
                        </td>
                        <td>
                            <?php echo $result['data181'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>SYNTH LOCK/REV SENSE</td>
                        <td>
                            <?php echo $result['data182'] ?>
                        </td>
                        <td>
                            <?php echo $result['data183'] ?>
                        </td>
                        <td>
                            <?php echo $result['data184'] ?>
                        </td>
                        <td>
                            <?php echo $result['data185'] ?>
                        </td>
                        <td>
                            <?php echo $result['data186'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>RF FREQ DIFFERENCE</td>
                        <td>
                            <?php echo $result['data187'] ?>
                        </td>
                        <td>
                            <?php echo $result['data188'] ?>
                        </td>
                        <td>
                            <?php echo $result['data189'] ?>
                        </td>
                        <td>
                            <?php echo $result['data190'] ?>
                        </td>
                        <td>
                            <?php echo $result['data191'] ?>
                        </td>
                    </tr>
                    <tr>
                        <td>ANTENNA FAULT</td>
                        <td>
                            <?php echo $result['data192'] ?>
                        </td>
                        <td>
                            <?php echo $result['data193'] ?>
                        </td>
                        <td>
                            <?php echo $result['data194'] ?>
                        </td>
                        <td>
                            <?php echo $result['data195'] ?>
                        </td>
                        <td>
                            <?php echo $result['data196'] ?>
                        </td>
                    </tr>
                </tbody>
            </table>
