                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="text" class="form-control" id="username" name="username"
                                placeholder="Username : admin" aria-describedby="addon-wrapping" autocomplete="off">
                        </div>
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <input type="password" class="form-control" id="password" name="password"
                                placeholder="Password : admin" aria-describedby="addon-wrapping" autocomplete="off">
                        </div>
