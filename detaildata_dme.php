...
include "koneksi.php";
$query = mysqli_query($koneksi, "SELECT * FROM tb_dme WHERE id='$id'");
...
<body>
    ...
    <div class="container-sm mb-5" style="background-color:white; max-width:80%; height:auto;">
        <h3 class="text-center p-3">DETAIL DATA DME MOPIENS MARU 320</h3>
        ...
        <center>
            <a href="data_dme.php" class="btn btn-secondary m-3">KEMBALI</a>
